...
async function getBuildAction() {
  const mod = await import('./buildAction-59da474c.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-013053d1.js');
...
async function getDevAction() {
  const mod = await import('./devAction-62186c29.js');
  return mod.default;
}
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-94214799.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-cb5efc83.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deleteApiAction-5adcc88e.js');
    return mod.default(args, context);
  },
  helpText: helpText$2
};
...
//# sourceMappingURL=_internal-5a07e844.js.map
