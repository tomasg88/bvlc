...
const inputs = {
  ...
  inCurrentDocument: {
    ...
    options: [{
      name: "true",
      title: "True",
      value: groq__default.default(_a$k || (_a$k = __template$k(["_id in $documentAssetIds"])))
    }, {
      name: "false",
      title: "False",
      value: groq__default.default(_b$b || (_b$b = __template$k(["!(_id in $documentAssetIds)"])))
    }],
    selectOnly: true,
  ...
  inUse: {
    ...
    options: [{
      name: "true",
      title: "True",
      value: groq__default.default(_c$3 || (_c$3 = __template$k(["count(*[references(^._id)]) > 0"])))
    }, {
      name: "false",
      title: "False",
      value: groq__default.default(_d$2 || (_d$2 = __template$k(["count(*[references(^._id)]) == 0"])))
    }],
    title: "In use",
    type: "select",
    value: "true"
...
const constructFilter = _ref => {
  ...
  const baseFilter = groq__default.default(_a$j || (_a$j = __template$j(["\n    _type in ", ' && !(_id in path("drafts.**"))\n  '])), JSON.stringify(documentAssetTypes));
...
const checkTagName = (client, name) => {
  return function (source) {
    return source.pipe(operators$1.mergeMap(() => {
      return rxjs.from(client.fetch(groq__default.default(_a$i || (_a$i = __template$i(['count(*[_type == "', '" && name.current == $name])'])), TAG_DOCUMENT_NAME), {
        name
      }));
...
const DIALOG_ACTIONS = {
  ...
  showTagEdit: toolkit.createAction("dialog/showTagEdit", function prepare(_ref8) {
    let {
      tagId
    } = _ref8;
    return {
...
const tagsSlice = toolkit.createSlice({
  ...
  reducers: {
    ...
    fetchRequest: {
      ...
      prepare: () => {
        const query = groq__default.default(_a$h || (_a$h = __template$h(['\n          {\n            "items": *[\n              _type == "', '"\n              && !(_id in path("drafts.**"))\n            ] {\n              _createdAt,\n              _updatedAt,\n              _id,\n              _rev,\n              _type,\n              name\n            } | order(name.current asc),\n          }\n        '])), TAG_DOCUMENT_NAME);
        return {
          payload: {
            query
          }
...
const tagsCreateEpic = (action$, state$, _ref9) => {
  let {
    client
  } = _ref9;
  return action$.pipe(operators$1.filter(tagsSlice.actions.createRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref10 => {
    let [action, state] = _ref10;
    const {
      assetId,
      name
    } = action.payload;
...
const tagsDeleteEpic = (action$, state$, _ref11) => {
  let {
    client
  } = _ref11;
  return action$.pipe(operators$1.filter(tagsSlice.actions.deleteRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref12 => {
    let [action, state] = _ref12;
    const {
      tag
    } = action.payload;
    ...
    operators$1.mergeMap(() => client.observable.fetch(groq__default.default(_b$9 || (_b$9 = __template$h(['*[\n              _type in ["sanity.fileAsset", "sanity.imageAsset"]\n              && references(*[_type == "media.tag" && name.current == $tagName]._id)\n            ] {\n              _id,\n              _rev,\n              opt\n            }']))), {
...
const tagsFetchEpic = (action$, state$, _ref13) => {
  let {
    client
  } = _ref13;
  return action$.pipe(operators$1.filter(tagsSlice.actions.fetchRequest.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref14 => {
    let [action, state] = _ref14;
    const {
      query
    } = action.payload;
    return rxjs.of(action).pipe(
...
const tagsUpdateEpic = (action$, state$, _ref15) => {
  let {
    client
  } = _ref15;
  return action$.pipe(operators$1.filter(tagsSlice.actions.updateRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref16 => {
...
const searchFacetTagUpdateEpic = (action$, state$) => action$.pipe(operators$1.filter(tagsActions.updateComplete.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref17 => {
...
const UPLOADS_ACTIONS = {
  uploadComplete: toolkit.createAction("uploads/uploadComplete", function prepare(_ref18) {
    let {
      asset
    } = _ref18;
    return {
...
const assetsSlice = toolkit.createSlice({
  ...
  reducers: {
    ...
    insertUploads(state, action) {
      ...
      Object.entries(results).forEach(_ref20 => {
        let [hash, assetId] = _ref20;
...
const assetsDeleteEpic = (action$, _state$, _ref21) => {
  let {
    client
  } = _ref21;
  return action$.pipe(operators$1.filter(assetsActions.deleteRequest.match), operators$1.mergeMap(action => {
    ...
    return rxjs.of(assets).pipe(operators$1.mergeMap(() => client.observable.delete({
      query: groq__default.default(_c$2 || (_c$2 = __template$g(["*[_id in ", "]"])), JSON.stringify(assetIds))
...
const assetsFetchEpic = (action$, state$, _ref22) => {
  let {
    client
  } = _ref22;
  return action$.pipe(operators$1.filter(assetsActions.fetchRequest.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref23 => {
...
const assetsFetchPageIndexEpic = (action$, state$) => action$.pipe(operators$1.filter(assetsActions.loadPageIndex.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref24 => {
  ...
  return rxjs.of(assetsActions.fetchRequest({
    ...
    selector: groq__default.default(_d$1 || (_d$1 = __template$g(["[", "...", "]"])), start, end),
    sort: groq__default.default(_e || (_e = __template$g(["order(", " ", ")"])), (_d2 = (_c2 = state.assets) == null ? void 0 : _c2.order) == null ? void 0 : _d2.field, (_f = (_e2 = state.assets) == null ? void 0 : _e2.order) == null ? void 0 : _f.direction)
  }));
}));
const assetsFetchNextPageEpic = (action$, state$) => action$.pipe(operators$1.filter(assetsActions.loadNextPage.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref25 => {
  let [_action, state] = _ref25;
  return rxjs.of(assetsActions.loadPageIndex({
    pageIndex: state.assets.pageIndex + 1
  }));
}));
const assetsFetchAfterDeleteAllEpic = (action$, state$) => action$.pipe(operators$1.filter(assetsActions.deleteComplete.match), operators$1.withLatestFrom(state$), operators$1.switchMap(_ref26 => {
  let [_action, state] = _ref26;
...
const patchOperationTagAppend = _ref27 => {
  let {
    tag
  } = _ref27;
...
const patchOperationTagUnset = _ref28 => {
  let {
    asset,
    tag
  } = _ref28;
...
const assetsTagsAddEpic = (action$, state$, _ref29) => {
  let {
    client
  } = _ref29;
  return action$.pipe(operators$1.filter(ASSETS_ACTIONS.tagsAddRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref30 => {
...
const assetsTagsRemoveEpic = (action$, state$, _ref31) => {
  let {
    client
  } = _ref31;
  return action$.pipe(operators$1.filter(ASSETS_ACTIONS.tagsRemoveRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref32 => {
...
const assetsUpdateEpic = (action$, state$, _ref33) => {
  let {
    client
  } = _ref33;
  return action$.pipe(operators$1.filter(assetsActions.updateRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref34 => {
    let [action, state] = _ref34;
    const {
      asset,
      closeDialogId,
      formData
...
var _a$e;
const Container$1 = styled__default.default(ui.Box)(_ref35 => {
  let {
    scheme,
    theme
  } = _ref35;
...
const SearchFacetNumber = _ref36 => {
  let {
    facet
  } = _ref36;
  var _a;
...
const SearchFacetSelect = _ref37 => {
  let {
    facet
  } = _ref37;
  var _a;
...
const SearchFacetString = _ref38 => {
  let {
    facet
  } = _ref38;
  const dispatch = reactRedux.useDispatch();
...
var _a$d;
const StackContainer = styled__default.default(ui.Flex)(_ref42 => {
  let {
    theme
  } = _ref42;
...
var _a$c;
const Container = styled__default.default(ui.Box)(_ref46 => {
  let {
    theme
  } = _ref46;
...
const reactSelectStyles = scheme => {
  return {
    ...
    indicatorsContainer: (styles, _ref48) => {
      let {
        isDisabled
      } = _ref48;
      return {
...
const StyledErrorOutlineIcon = styled__default.default(ErrorOutlineIcon)(_ref51 => {
  let {
    theme
  } = _ref51;
  return {
...
const VirtualRow$1 = react.memo(_ref54 => {
  let {
    isScrolling,
    item
  } = _ref54;
...
const CardContainer = styled__default.default(ui.Flex)(_ref56 => {
  let {
    picked,
    theme,
    updating
...
const ContextActionContainer$2 = styled__default.default(ui.Flex)(_ref57 => {
  let {
    scheme
  } = _ref57;
  return styled.css(_d || (_d = __template$7(["\n    cursor: pointer;\n    height: ", "px;\n    transition: all 300ms;\n    @media (hover: hover) and (pointer: fine) {\n      &:hover {\n        background: ", ";\n      }\n    }\n  "])), PANEL_HEIGHT, getSchemeColor(scheme, "bg"));
});
const StyledWarningOutlineIcon = styled__default.default(WarningFilledIcon)(_ref58 => {
  let {
    theme
  } = _ref58;
  return {
...
const uploadsAssetStartEpic = (action$, _state$, _ref59) => {
  let {
    client
  } = _ref59;
...
const uploadsAssetUploadEpic = (action$, state$) => action$.pipe(operators$1.filter(uploadsActions.uploadRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref60 => {
  let [action, state] = _ref60;
  const {
    file,
    forceAsAssetType
  } = action.payload;
...
const uploadsCheckRequestEpic = (action$, state$, _ref61) => {
  let {
    client
  } = _ref61;
  return action$.pipe(operators$1.filter(uploadsActions.checkRequest.match), operators$1.withLatestFrom(state$), operators$1.mergeMap(_ref62 => {
    let [action, state] = _ref62;
    const {
      assets
    } = action.payload;
...
const VirtualCell = react.memo(_ref63 => {
  let {
    item,
    selected
  } = _ref63;
...
var _a$3;
const ContextActionContainer$1 = styled__default.default(ui.Flex)(_ref64 => {
  let {
    scheme
  } = _ref64;
...
const ContainerGrid = styled__default.default(ui.Grid)(_ref65 => {
  let {
    scheme,
    selected,
    updating
...
const ContextActionContainer = styled__default.default(ui.Flex)(_ref66 => {
  let {
    scheme
  } = _ref66;
  return styled.css(_c || (_c = __template$2(["\n    cursor: pointer;\n    @media (hover: hover) and (pointer: fine) {\n      &:hover {\n        background: ", ";\n      }\n    }\n  "])), getSchemeColor(scheme, "bg2"));
});
const StyledWarningIcon = styled__default.default(WarningFilledIcon)(_ref67 => {
  let {
    theme
  } = _ref67;
  return {
...
const VirtualRow = react.memo(_ref69 => {
  let {
    item,
    selected
  } = _ref69;
